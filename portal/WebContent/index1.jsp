		...
		<div class="Corpo">
			...
			<div class="sislegis_mainCol">
				...
				<div class="materia">
					...
					Todos os documentos administrativos e de processos licitatórios que devem ser publicados se encontram nesta seção.
					</span>
					</p>
				</div>
          ...
          <%
            ...
            List<Documento> listDocumentos = Seeker.getInstance().prepararPesquisa(null,td).getLista();
				...
				<div class="ContainersRight">
					...
					<%
						...
						td = Seeker.getInstance().tdDao.selectOne(new Tipodoc(1));
						 listDocumentos = Seeker.getInstance().prepararPesquisa(null,td).getLista();
